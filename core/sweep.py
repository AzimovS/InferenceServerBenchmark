...
def write_env(model: dict, enable_prefix_caching: bool = True, hf_token: str | None = None):
    ...
    # Custom images bake patched source/deps; reinstalling vllm[audio] in the
    # entrypoint can clobber those changes and break model loading.
